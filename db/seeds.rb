...
mainUser = User.create(nick_name: "Reina", first_name: "Reina", last_name: "Nunez", card_number: "4245567834566789", email: "reina@gmail.com", login_pin: 6424, password: "password", password_confirmation: "password", role: "Admin", admin: true)
